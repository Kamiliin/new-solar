...
<html lang="en">
 ...
 <!-- comienzo portada  -->
    ...
    <div class="container-fluid bg-blue" id="formulario-contacto" >
    ...
    <div class="container p-md-5">
        <div class="row">
            <div class="col-12">
                <div class="row bg-section p-md-5 justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-12 py-2 d-flex">
                        <div class="card mx-auto" style="width: 100%; max-width: 22rem;">
                            <img src="https://solarysustentablechile.cl/img/card1.jpeg" class="card-img-top" alt="Energía Solar Hogar" style="height: 200px; object-fit: cover;">
                            <div class="card-body">
                                <h5 class="card-title">Energía Solar Hogar</h5>
                                <p class="card-text">En un mundo que valora la sostenibilidad y la eficiencia energética, es hora de que tu hogar se una a la revolución solar. La energía solar no solo es amigable con el medio ambiente, sino que también te permite ahorrar dinero a largo plazo.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 py-2 d-flex">
                        <div class="card mx-auto" style="width: 100%; max-width: 22rem;">
                            <img src="https://solarysustentablechile.cl/img/card2.jpeg" class="card-img-top" alt="Energía Solar Empresas" style="height: 200px; object-fit: cover;">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 py-2 d-flex">
                        <div class="card mx-auto" style="width: 100%; max-width: 22rem;">
                            <img src="https://solarysustentablechile.cl/img/card2.jpeg" class="card-img-top" alt="Servicio Técnico" style="height: 200px; object-fit: cover;">
                            <div class="card-body">
